...
var EventType;
(function (EventType) {
    EventType[EventType["Conference"] = 0] = "Conference";
    EventType[EventType["Concert"] = 1] = "Concert";
})(EventType || (EventType = {}));
...
var Customer = function () {
    ...
    var Customer = _classThis = /** @class */ (function () {
        function Customer_1(id, name, event, details) {
            this.id = id;
            this.name = name;
            this.event = event;
            this.details = details;
        }
        Customer_1.prototype.getInfo = function () {
...
var customer = new Customer(1, "Nandhu", EventType.Concert, [101, "VIP"]);
